...
public interface PlaceRepository extends JpaRepository<Place, Integer> {
    ...
    @Query(value = "SELECT p FROM Place p WHERE ST_Distance(p.coordinates, :center) <= :radius")
    List<Place> findByCoordinatesWithinRadius(@Param("center") Point center, @Param("radius") double radius);
